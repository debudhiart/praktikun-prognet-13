                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-3">
                                ...
                                <ul class="nav-vrt white opc none-padding">
                                    <li>
                                        <a href="/" class="btn-material">Home</a>
                                    </li>

                                    <li>
                                        <a href="kategori" class="btn-material">Category</a>
                                    </li>

                                    <li>
                                        <a href="about" class="btn-material">About Us</a>
                                    </li>
                                </ul>
                ...
                <div class="row">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <span class="copy">
                                    © 2020 Praktikum Prognet. All rights reserved.
                                </span>
                            </div>
